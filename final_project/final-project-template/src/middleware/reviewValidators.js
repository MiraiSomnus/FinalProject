...
export const validateCreateReview = [
  ...
  body('content')
    ...
    .bail()
    .isInt({min:1, max:5})
    .withMessage('Rating must be an Positive Integer within the range of 1 to 5'),
...
export const validateUpdateReview = [
  ...
  body('rating')
    .optional()
    .isInt({min:1, max:5})
    .withMessage('Rating must be an Integer within the range of 1 to 5'),
...
export const validateReviewQuery = [
 query('sortBy')
    .optional()
    .isIn(['id', 'title', 'content','rating', 'createdAt'])
